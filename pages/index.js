      ...
      <div className="page">
        ...
        <section className="hero">
          ...
          <h1 className="heroTitle">
            Diagnóstico avanzado para fallas que{" "}
            <span className="heroTitleHighlight">otros talleres no resolvieron</span>
          </h1>
          ...
          <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="heroCta">
              ...
              <div key={i} className={`testimonialCard anim`} style={{ transitionDelay: `${i * 0.12}s` }}>
                ...
                <div className="testimonialAuthor">
                  ...
                  <div>
                    ...
                    <div className="testimonialCar">{t.car}</div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section className="ctaSection">
          <div className="ctaBox">
            ...
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="ctaButton">
              <span>💬</span> Agendar diagnóstico ahora
            </a>
          </div>
        </section>
      ...
      <style jsx global>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .navbar {
          ...
          padding: 16px 24px; transition: 0.3s ease;
        ...
        .heroBadge {
          ...
          color: var(--accent-lt); margin-bottom: 28px; animation: fadeUp 0.8s 0.2s ease both;
        }
        .heroBadgeDot { width: 8px; height: 8px; border-radius: 50%; background: var(--green); animation: pulseDot 2s ease-in-out infinite; }
        .heroTitle {
          font-size: clamp(30px, 6vw, 56px); font-weight: 700; line-height: 1.1;
          max-width: 800px; margin-bottom: 20px; letter-spacing: -1px;
          animation: fadeUp 0.8s 0.4s ease both;
        }
        .heroTitleHighlight {
          background: linear-gradient(135deg, var(--accent-lt), var(--accent), #6366f1);
          -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;
        }
        .heroDesc {
          font-size: clamp(16px, 2.5vw, 20px); color: var(--t2);
          max-width: 520px; line-height: 1.6; margin-bottom: 12px;
          font-weight: 300; animation: fadeUp 0.8s 0.6s ease both;
        }
        ...
        .heroCta {
          ...
          transition: 0.3s ease; animation: fadeUp 0.8s 0.8s ease both;
        ...
        .heroScrollHint {
          ...
          color: var(--t3); font-size: 11px; letter-spacing: 2px;
          text-transform: uppercase; animation: fadeIn 1s 1.5s ease both;
        }
        ...
        .stepDot {
          ...
          border: 2px solid var(--glass-b); display: flex; align-items: center;
          justify-content: center; font-size: 24px; margin-bottom: 16px;
          transition: 0.3s ease; position: relative;
        }
        .stepNumber {
          position: absolute; top: -8px; right: -4px; width: 22px; height: 22px;
        ...
        .serviceCard {
          background: var(--glass); border: 1px solid var(--glass-b);
          border-radius: var(--r-lg); padding: 32px 28px; transition: 0.3s ease;
        ...
        .testimonialText {
          font-size: 15px; color: var(--t2); line-height: 1.7; flex: 1;
        ...
        .ctaBox {
          ...
          border: 1px solid rgba(124,58,237,0.2); border-radius: var(--r-xl);
          padding: 60px 40px; text-align: center; position: relative; overflow: hidden;
        }
        .ctaBox::before {
          content: ''; position: absolute; top: -50%; left: -50%; width: 200%; height: 200%;
          background: radial-gradient(circle at 50% 50%, rgba(124,58,237,0.08), transparent 50%);
        ...
        .ctaButton {
          display: inline-flex; align-items: center; gap: 10px;
          background: var(--green); color: #000; padding: 18px 40px;
          border-radius: var(--r-md); font-size: 17px; font-weight: 700;
          text-decoration: none; border: none; cursor: pointer;
          transition: 0.3s ease; font-family: var(--font); position: relative;
        }
        ...
        .floatingWhatsapp {
          ...
          transition: 0.3s ease; animation: waFloat 3s ease-in-out infinite;
        }
        ...
        .floatingTooltip {
          ...
          color: var(--t1); padding: 10px 16px; border-radius: var(--r-sm);
          font-size: 13px; font-weight: 500; white-space: nowrap;
          pointer-events: none; animation: tooltipFade 4s ease-in-out infinite;
        ...
        @media (max-width: 768px) {
          ...
          .navLinks.mobileOpen {
            ...
            border-bottom: 1px solid var(--glass-b); padding: 20px 24px; gap: 16px;
          }
